...
![404]({{ site.baseurl }}/images/ml/regression.png)
...
![404]({{ site.baseurl }}/images/ml/jointandmarginal.PNG)
...
![404]({{ site.baseurl }}/images/ml/training2.PNG)
...
![404]({{ site.baseurl }}/images/ml/noinv.png)
...
![404]({{ site.baseurl }}/images/ml/gausslab2.png)
...
![404]({{ site.baseurl }}/images/ml/kernel1.png)
...
![404]({{ site.baseurl }}/images/ml/kneighbor2.png)
...
![404]({{ site.baseurl }}/images/ml/tradeoff.png)
...
![404]({{ site.baseurl }}/images/ml/onevsrest.png)
![404]({{ site.baseurl }}/images/ml/onevsone.png)
...
![404]({{ site.baseurl }}/images/ml/0_1.png)
![404]({{ site.baseurl }}/images/ml/1_1.png)
![404]({{ site.baseurl }}/images/ml/0_2.png)
![404]({{ site.baseurl }}/images/ml/1_2.png)
...
```
![404]({{ site.baseurl }}/images/ml/0vs1.png)
...
![404]({{ site.baseurl }}/images/ml/hypothesis.png)
...
![404]({{ site.baseurl }}/images/ml/likelihoods.png)
...
![404]({{ site.baseurl }}/images/ml/trained_theta.png)
...
![404]({{ site.baseurl }}/images/ml/theta_vector.png)
...
![404]({{ site.baseurl }}/images/ml/learning_curve_1.png)
![404]({{ site.baseurl }}/images/ml/learning_curve_2.png)
...
![404]({{ site.baseurl }}/images/ml/non-linear1.PNG)
...
![404]({{ site.baseurl }}/images/ml/non-linear2.PNG)

#### Defnining the cost function (to measure the quality of the hypotheses)
![404]({{ site.baseurl }}/images/ml/non-linear3.PNG)
...
![404]({{ site.baseurl }}/images/ml/non-linear4.PNG)
...
![404]({{ site.baseurl }}/images/ml/measure_of_improvement.PNG)
...
![404]({{ site.baseurl }}/images/ml/measure_of_improvement2.PNG)
![404]({{ site.baseurl }}/images/ml/measure_of_improvement3.PNG)
![404]({{ site.baseurl }}/images/ml/measure_of_improvement4.PNG)
...
![404]({{site.baseurl}}/images/ml/trick.PNG)
...
![404]({{site.baseurl}}/images/ml/perceptron.PNG)
...
![404]({{site.baseurl}}/images/ml/perceptron-c.PNG)

* Doing so creates a network of classifiers outputs linked to classifier inputs

![404]({{site.baseurl}}/images/ml/perceptron-n.PNG)
...
![404]({{site.baseurl}}/images/ml/perceptron-terminology.PNG)
...
![404]({{site.baseurl}}/images/ml/perceptron-m.PNG)
...
![404]({{site.baseurl}}/images/ml/distribution.png)
...
![404]({{site.baseurl}}/images/ml/information_gain.png)
...
![404]({{site.baseurl}}/images/ml/entropy.png)
...
![404]({{site.baseurl}}/images/ml/threshold.png)

## Unsupervised learning
![404]({{ site.baseurl }}/images/ml/sup_vs_unsup.PNG)
### Dimentinality reduction
* We may be able to improve the "distinctiviness" of the classifier by using more features, however some features are more useful than others, some being compeletely useless.
...
![404]({{site.baseurl}}/images/ml/pca1.PNG)

* The choice for these weights is based on PCA:
  * Principal Components Analysis maps the data onto a lienar subspace, such that the variance of the projected data is maximized.

### Linear algebra re-cap
#### Variance vs covariance
* Variance = the average squared difference of the data points against the mean
* Covariance = the direction in wich two random variables change when they are compared to each other

![404]({{site.baseurl}}/images/ml/variance.PNG)

* The covariance matrix contains all the covariances

![404]({{site.baseurl}}/images/ml/covariance.PNG)

* We can shift the data points to have 0 means to make computation easier:

![404]({{site.baseurl}}/images/ml/covariance2.PNG)
...
![404]({{site.baseurl}}/images/ml/eigenv.PNG)

* Eigenpairs can be found with the characteristic equation:
  * \\(det(A-\lambda I)=0\\)
* Alternatively, you can use "power itereation", which bruteforces the calculation below until it converges:
  * $$x_{k+1} := \frac{M_{x_k}}{||{M_{x_k}}||}$$
  * Then calculate \\(\lambda_1\\) as usual, by solving \\(Mx=\lambda x\\) or by doing \\($λ = \mathbf{v}^\intercal M\mathbf{v}\\)
  * And get the second eigen pair by using power iteration on the new Matrix M*:\\(M^\*=M-\lambda_1xx^T\\)
    * \\(xx^T\\) is also known as the **outer product** of v with itself
...
![404]({{site.baseurl}}/images/ml/pca2.PNG)
![404]({{site.baseurl}}/images/ml/pca3.PNG)
![404]({{site.baseurl}}/images/ml/pca4.PNG)
...
### Clustering
![404]({{site.baseurl}}/images/ml/clustering1.PNG)
![404]({{site.baseurl}}/images/ml/clustering2.PNG)
![404]({{site.baseurl}}/images/ml/clustering3.PNG)
![404]({{site.baseurl}}/images/ml/clustering4.PNG)

#### K-means clustering
![404]({{site.baseurl}}/images/ml/kmeans1.PNG)
...
![404]({{site.baseurl}}/images/ml/kmeans2.PNG)
![404]({{site.baseurl}}/images/ml/kmeans3.PNG)
![404]({{site.baseurl}}/images/ml/kmeans4.PNG)
...
![404]({{site.baseurl}}/images/ml/kmeans5.PNG)

#### Hirearchical clustering
![404]({{site.baseurl}}/images/ml/hirearchichal1.PNG)
![404]({{site.baseurl}}/images/ml/hirearchichal2.PNG)
![404]({{site.baseurl}}/images/ml/hirearchichal3.PNG)
![404]({{site.baseurl}}/images/ml/hirearchichal4.PNG)
![404]({{site.baseurl}}/images/ml/hirearchichal5.PNG)
![404]({{site.baseurl}}/images/ml/hirearchichal6.PNG)
![404]({{site.baseurl}}/images/ml/hirearchichal7.PNG)
![404]({{site.baseurl}}/images/ml/hirearchichal8.PNG)
![404]({{site.baseurl}}/images/ml/hirearchichal9.PNG)
![404]({{site.baseurl}}/images/ml/hirearchichal10.PNG)
![404]({{site.baseurl}}/images/ml/hirearchichal11.PNG)
![404]({{site.baseurl}}/images/ml/hirearchichal12.PNG)
![404]({{site.baseurl}}/images/ml/hirearchichal13.PNG)
![404]({{site.baseurl}}/images/ml/hirearchichal14.PNG)
![404]({{site.baseurl}}/images/ml/hirearchichal15.PNG)
![404]({{site.baseurl}}/images/ml/hirearchichal16.PNG)
...
$$\mathbf{v}_{k+1} = \dfrac{M\mathbf{v}_{k}}{||M\mathbf{v}_{k}||}$$
where \\(||M\mathbf{v_k}||\\) is the (L2) norm (length) of \\(M\mathbf{v}_{k}\\).
3. Output vector \\(\mathbf{v}\\) as the principal eigenvector of \\(M\\).
4. Compute \\(M^∗\\) as:  
$$\lambda = \mathbf{v}^\intercal M\mathbf{v}$$
$$M^∗ = M − λ × \mathbf{vv}^\intercal$$
...
![404]({{ site.baseurl }}/images/ml/pcalab.PNG)
...
$$cov(X) = \sum{\dfrac{1}{N}(X - \bar{x})^\intercal(X - \bar{x})}$$
...
plt.quiver(*origin, V[:,0], V[:,1], angles='xy', scale_units='xy', color=['r','b','g'], scale=1)
plt.xlim(-3, 3)
plt.ylim(-3, 3)
plt.show()
...
![404]({{ site.baseurl }}/images/ml/vectors.PNG)
...
* Create a matrix object and let it read in `data/faces.txt`. This matrix is of size \\(N × D\\), where N is the number of images in the dataset and D is the number of pixels per image (in this case 32 × 32, so D = 1024). Similar as before, compute the covariance matrix. Use this covariance matrix to compute the first 10 principal components and visualize them using the given `create_image()` function.    
...
* mean face:
![404]({{ site.baseurl }}/images/ml/mean_face.PNG)

* (principal) eigen vector face (other 9 vector faces are skipped here):
![404]({{ site.baseurl }}/images/ml/vector_face.PNG)
...
![404]({{ site.baseurl }}/images/ml/audio_features.PNG)

* Obviousy these (arbitrarily selected) features are not useful for making up distinct groups. But we can use PCA to get the eigen vectors of the features with most variance (and hence easier to group into distinct groups)
...
eigenvectors = power_iteration(cov_X, 4, 10 ** -5)
# END ANSWER
...
![404]({{ site.baseurl }}/images/ml/vectors_digits.PNG)
...
* Step 1: initalize k cluster centrers at random locations
...
![404]({{ site.baseurl }}/images/ml/first_centroids.PNG)

...

![404]({{ site.baseurl }}/images/ml/last_centroids.PNG)

![404]({{ site.baseurl }}/images/ml/true_labels.PNG)

* Step 5: Now that we have a cluster, we would like to find out how good our clustering is. We will also do this using an unsupervised approach: without knowing the correct labels for each cluster, we _can_ say something about the spread of each cluster.
...
![404]({{ site.baseurl }}/images/ml/tune.PNG)