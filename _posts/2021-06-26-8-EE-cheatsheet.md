...
![Breadboard]({{ site.baseurl }}/images/ee/circuitcheatsheet.PNG)
...
![404]({{ site.baseurl }}/images/ee/power.PNG)
...
![404]({{ site.baseurl }}/images/ee/kcl.PNG)
...
![404]({{ site.baseurl }}/images/ee/kvl.PNG)
...
![404]({{ site.baseurl }}/images/ee/kvl2.PNG)
...
![404]({{ site.baseurl }}/images/ee/kvl3.PNG)

Example to solve for \\(i_1\\):

![404]({{ site.baseurl }}/images/ee/kvl4.PNG)

![404]({{ site.baseurl }}/images/ee/kvl5.PNG)
...
![404]({{ site.baseurl }}/images/ee/dcs.PNG)
...
![404]({{ site.baseurl }}/images/ee/dcs2.PNG)
...
Example:
![404]({{ site.baseurl }}/images/ee/nvm.PNG)
...
![404]({{ site.baseurl }}/images/ee/nvm2.PNG)
...
![404]({{ site.baseurl }}/images/ee/mcm.PNG)
...
![404]({{ site.baseurl }}/images/ee/sm.PNG)
...
![404]({{ site.baseurl }}/images/ee/series.PNG)
* Parallel resistors
  * The current branches

![404]({{ site.baseurl }}/images/ee/parallel.png)
...
![404]({{ site.baseurl }}/images/ee/st.PNG)
...
![404]({{ site.baseurl }}/images/ee/cip.PNG)
...
![404]({{ site.baseurl }}/images/ee/tec.PNG)
...
Examle: 
![404]({{ site.baseurl }}/images/ee/tec2.PNG)
...
![404]({{ site.baseurl }}/images/ee/tec3.PNG)
...
![404]({{ site.baseurl }}/images/ee/vd.PNG)
...
![404]({{ site.baseurl }}/images/ee/vd2.PNG)
...
![404]({{ site.baseurl }}/images/ee/cdc.PNG)

### Maximum Power transfer
* We can model the load that we want as a resistor

![404]({{ site.baseurl }}/images/ee/pt.PNG)
...
![404]({{ site.baseurl }}/images/ee/mpt.PNG)
...
### Inductor (L)
![404]({{ site.baseurl }}/images/ee/inductor.PNG)
* Unit: Henry (H)
...
![404]({{ site.baseurl }}/images/ee/inductorvoltagecurrent.PNG)
...
![404]({{ site.baseurl }}/images/ee/capacitor.PNG)
...
![404]({{ site.baseurl }}/images/ee/lr.PNG)
...
![404]({{ site.baseurl }}/images/ee/lr2.PNG)
...
![404]({{ site.baseurl }}/images/ee/lr3.PNG)

#### Time constant of an LR (inductor) Circuit
* \\(\tau = L/R\\)
![404]({{ site.baseurl }}/images/ee/tc.PNG)
...
![404]({{ site.baseurl }}/images/ee/sr.PNG)
...
![404]({{ site.baseurl }}/images/ee/sr2.PNG)

#### Step response of RC (capacitor) circuits
![404]({{ site.baseurl }}/images/ee/src.PNG)
...
* Symbol = +- triangle
![404]({{ site.baseurl }}/images/ee/opamp2.PNG)
...
![404]({{ site.baseurl }}/images/ee/opamp.PNG)
...
![404]({{ site.baseurl }}/images/ee/opamp3.PNG)

### Current
![404]({{ site.baseurl }}/images/ee/opamp4.PNG)
...
![404]({{ site.baseurl }}/images/ee/opamp5.PNG)
...
![404]({{ site.baseurl }}/images/ee/opamp6.PNG)
...
![404]({{ site.baseurl }}/images/ee/opamp9.PNG)
...
#### KCL example
![404]({{ site.baseurl }}/images/ee/opamp7.PNG)
...
![404]({{ site.baseurl }}/images/ee/opamp8.PNG)
  * KVL: \\(-V_0 + i_{100}\cdot 10^3 = 0\\)
    * \\(V_0=-4\\)

### Summing amplifier circuit
![404]({{ site.baseurl }}/images/ee/sac.PNG)
...
![404]({{ site.baseurl }}/images/ee/sac2.PNG)
...
![404]({{ site.baseurl }}/images/ee/nia.PNG)
* Or you can do it with just 1 amplifier
![404]({{ site.baseurl }}/images/ee/nia2.PNG)
...
![404]({{ site.baseurl }}/images/ee/nia3.PNG)
...
![404]({{ site.baseurl }}/images/ee/da.PNG)
...
![404]({{ site.baseurl }}/images/ee/iac.PNG)
