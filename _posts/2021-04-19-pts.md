...
![histogram]({{ site.url }}/images/pts/histogram_width.png)
...
![scatterplot]({{ site.url }}/images/pts/scatterplot.png)
...
![Total Probability]({{ site.url }}/images/pts/total_p.png)
...
![btree]({{ site.url }}/images/pts/btree.png)
...
![median]({{ site.url }}/images/pts/median.png)
#### kth percentile
...
![pareto]({{ site.url }}/images/pts/pareto.png)
...
![std]({{ site.url }}/images/pts/std.png)

![rtpstd]({{ site.url }}/images/pts/rtpstd.png)
...
![convex]({{ site.url }}/images/pts/convex.png)
...
![concave]({{ site.url }}/images/pts/concave.png)
...
![jointandmarginal]({{ site.url }}/images/pts/jointandmarginal.PNG)
