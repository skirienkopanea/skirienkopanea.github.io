...
- [Table of Contents](#table-of-contents)
  ...
  - [Draft workout](#draft-workout)
    ...
    - [Plyometrics workout (with progression)](#plyometrics-workout-with-progression)
...
* A plyometric plan progression could be
  ...
  * Intensification
    * Loading (eccentric strength, drop jumps, single leg hops)
    * Peak force (concentric strength, squat jumps, quarter squats, hang power cleans)
  * Peak
    * Bounce (running vertical)
    * Sprints
  ...
  * Use voodoobands (compression) and move the joints after training as pain-releaf / healing mechanism as it helps the circulation of blood and sinusidial liquids, etc.
  * Some swelling and degree of discomfort in the joints is normal but don't let it increase overtime, if so tune down the volume and or intensity
