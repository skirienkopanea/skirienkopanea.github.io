...
* A client and server are bound by a contract
...
* Liskhov substitution principle says that parent class tests hold for the children and hence these need not to be tested again, but inherit the test cases:
