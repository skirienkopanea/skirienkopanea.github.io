...
* TCP will use the minimum of min((network) congestion window, (reciever) window size) (or a small multiple of it)
...
* The encryption key is called public key and denoted \\(K_{pub}\\).
...
* IPSec has multiple modes depending on the role of teh communication partners:
