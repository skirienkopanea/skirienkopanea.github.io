...
* The link layer wraps all the units of data, and the rest of the layers wraps those above, like a matrioshka:
  ...
  * Application layer uses sockets
...
* Random Early Detection drops packets randomly if buffer space is almost full
...
* The segment contains a socket: an object associated with a local address (in most application that is the port)
