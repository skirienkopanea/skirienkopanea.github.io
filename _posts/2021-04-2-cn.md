...
<<<<<<< HEAD
    - [Caesar cipher](#caesar-cipher)
=======
>>>>>>> 38cc0980b10a6e0f36cadb153b8a1d1652673149
...
* The parties using the key must communicate via a secure channel to ensure the secrecy of the key.
  
#### Stream ciphers
* Act on each character of the plaintext individually

#### Block ciphers
* Divide the plain text in blocks of equal length and then act on each blok